    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 9000, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(4px)' }} onClick={onClose}>
      ...
      {(onApply || isOwner) && (
        <div style={{
          ...
          {isOwner ? (
            <div style={{ padding: '14px', borderRadius: 16, border: '1.5px solid rgba(234,153,166,0.25)', background: 'rgba(253,164,175,0.05)', color: '#B76E79', fontWeight: 500, fontSize: 13, textAlign: 'center' }}>
