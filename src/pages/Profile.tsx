...
function ProfileSkeleton() {
  return (
    <div
  className="bg-[#F8F9F4] pb-20 animate-pulse pt-[env(safe-area-inset-top)]"
...
export default function Profile() {
 ...
 const getInitialProfileTab = (): ProfileTab => {
  ...
  const hasTennisProfile =
    !!profile?.tennis_style ||
    !!profile?.tennis_photo_url;
...
const isSubscribed = profile?.is_subscribed ?? false;
  ...
  return (
    <div
  className="bg-[#F8F9F4] pb-20 pt-[env(safe-area-inset-top)]"
  style={{ minHeight: `${vpHeight}px` }}
>
     <header className="bg-white border-b border-gray-200 px-6 pt-2 pb-0 sticky top-0 z-10">
