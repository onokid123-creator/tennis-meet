      ...
      >
        ...
        <div className="px-4 pb-3 flex gap-2">
          <button
            ...
            style={categoryTab === 'tennis'
              ? { background: 'rgba(255,255,255,0.22)', color: '#fff', border: '1.5px solid rgba(255,255,255,0.4)', backdropFilter: 'blur(8px)', textShadow: '0 1px 4px rgba(0,0,0,0.2)' }
              : { background: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.72)', border: '1.5px solid rgba(255,255,255,0.15)' }
            }
          >
            🎾 오직 테니스
          </button>
        ...
        <div className="flex" style={{ borderTop: isDating ? '1px solid rgba(251,113,133,0.2)' : '1px solid rgba(201,168,76,0.2)' }}>
          <button
            ...
            style={{ color: activeTab === 'others' ? '#fff' : 'rgba(255,255,255,0.68)', textShadow: activeTab === 'others' ? '0 1px 4px rgba(0,0,0,0.25)' : 'none' }}
          >
          ...
          <button
            ...
            className="flex-1 py-3 text-sm font-semibold transition-all duration-200 relative"
            style={{ color: activeTab === 'mine' ? '#fff' : 'rgba(255,255,255,0.68)', textShadow: activeTab === 'mine' ? '0 1px 4px rgba(0,0,0,0.25)' : 'none' }}
          >
            내 코트
            {activeTab === 'mine' && (
              <div
